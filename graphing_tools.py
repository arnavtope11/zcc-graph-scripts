...
def plot_tp_latency_curve_const_pinning_limit(whole_dataframe: pd.DataFrame, op_folder: str):
    system_names = ['vanilla_cornflakes', 'cornflakes_copy']
    ...
    for pin_limit in pinning_limits:
        ...
        multiple_line_plot(plot_lines, 'achieved_load_pps', 'p99',
                           f'p99 vs achieved_load_pps_pl{pin_limit}_1m20phs',
...
if __name__ == '__main__':
    ...
    # plot_tp_latency_curve_const_segment(dataset_dataframe)
    plot_tp_latency_curve_const_pinning_limit(dataset_dataframe, './graphs/8m20phs/const_pin_limit')
